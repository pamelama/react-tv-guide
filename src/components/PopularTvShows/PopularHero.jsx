let brackgroundImage =
  "https://image.tmdb.org/t/p/original/9GvhICFMiRQA82vS6ydkXxeEkrd.jpg";

const PopularHero = () => {
  return (
    <main
      className="bg-backdrop-home h-[500px] bg-cover bg-center"
      style={{
        backgroundImage: `url(${brackgroundImage})`,
      }}
    >
